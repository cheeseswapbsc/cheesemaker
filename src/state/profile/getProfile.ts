...
import { getProfileContract, getCnftYieldRabbitContract } from 'utils/contractHelpers'
...
const rabbitContract = getCnftYieldRabbitContract()
  ...
  try {
    ...
    if (isActive) {
      ...
      Cookies.set(
        ...
        {
          username,
          avatar: `https://cnftYieldswap.finance/images/nfts/${nft.images.sm}`,
        },
        { domain: 'cnftYieldswap.finance', secure: true, expires: 30 },
      )
    }
