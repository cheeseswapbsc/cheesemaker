...
import { Heading, Text, Flex, ChevronRightIcon } from '@cheeseswapfinance/uikit'
  ...
  return (
    <>
      <Heading as="h4" size="md" mb="8px">
        {TranslateString(999, 'CnftYield Collectibles')}
      </Heading>
      <Text as="p">
        {TranslateString(
          999,
      ...
      <Text as="p">
        {TranslateString(
          999,
          "NFTs in this user's wallet that aren't approved CnftYield Collectibles won't be shown here.",
        )}
      </Text>
      ...
      <Flex alignItems="center" justifyContent="flex-end">
        <Link to="/collectibles">{TranslateString(999, 'See all approved CnftYield Collectibles')}</Link>
        <ChevronRightIcon />
      </Flex>
    </>
  )
