...
import { Button, Flex, Heading, useModal, Won } from '@cheeseswapfinance/uikit'
import { useProfile } from 'state/hooks'
import useI18n from 'hooks/useI18n'
import ClaimNftAndCnftModal, { useCanClaim } from './ClaimGiftModal'
...
const ProfileHeader = () => {
  ...
  const [onPresentClaimGiftModal] = useModal(<ClaimNftAndCnftModal onSuccess={checkClaimStatus} />)
