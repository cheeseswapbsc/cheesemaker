...
import { AutoRenewIcon, Button, Card, CardBody, Heading, Skeleton, Text } from '@cheeseswapfinance/uikit'
...
import { useCnftYieldRabbits } from 'hooks/useContract'
...
const ProfilePicture: React.FC = () => {
  ...
  const handleApprove = () => {
    cnftYieldRabbitsContract.methods
      .approve(getCnftYieldProfileAddress(), tokenId)
      .send({ from: account })
      .on('sending', () => {
        setIsApproving(true)
      })
    ...
    return (
      <>
        ...
        <Text bold fontSize="20px" mb="24px">
          {TranslateString(854, 'We couldn’t find any CnftYield Collectibles in your wallet.')}
        </Text>
        <Text as="p">
          {TranslateString(
            856,
            'You need a CnftYield Collectible to finish setting up your profile. If you sold or transferred your starter collectible to another wallet, you’ll need to get it back or acquire a new one somehow. You can’t make a new starter with this wallet address.',
          )}
        </Text>
      </>
    )
      ...
      <Card mb="24px">
        <CardBody>
          ...
          <Text as="p" color="textSubtle" mb="24px">
            {TranslateString(816, 'Only approved CnftYield Collectibles can be used.')}
