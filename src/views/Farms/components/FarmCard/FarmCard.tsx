...
import { Flex, Text, Skeleton } from '@cheeseswapfinance/uikit'
...
const FarmCard: React.FC<FarmCardProps> = ({ farm, removed, cnftPrice, htPrice, ethPrice, account }) => {
  ...
  const earnLabel = farm.dual ? farm.dual.earnLabel : 'CNFT'
      ...
      {!removed && (
        <Flex justifyContent="space-between" alignItems="center">
          ...
          <Text bold style={{ display: 'flex', alignItems: 'center' }}>
            {farm.apy ? (
              <>
                <ApyButton lpLabel={lpLabel} addLiquidityUrl={addLiquidityUrl} cnftPrice={cnftPrice} apy={farm.apy} />
                {farmAPY}%
              </>
            ) : (
