...
const Nfts: Nft[] = [
  ...
  {
    name: 'Sleepy',
    description: 'Aww, looks like eating cnftYields all day is tough work. Sweet dreams!',
    images: {
      lg: 'sleepy-lg.png',
      md: 'sleepy-md.png',
      sm: 'sleepy-sm.png',
  ...
  {
    name: 'Sunny',
    description: 'Sunny is always cheerful when there are cnftYields around. Smile!',
    images: {
      lg: 'sunny-lg.png',
      md: 'sunny-md.png',
      sm: 'sunny-sm.png',
  ...
  {
    name: 'Churro',
    description: "Don't let that dopey smile deceive you... Churro's a master CNFT chef!",
    images: {
      lg: 'churro-lg.png',
      md: 'churro-md.png',
      sm: 'churro-sm.png',
  ...
  {
    name: 'Dollop',
    description: "Nommm... Oh hi, I'm just meditating on the meaning of CNFT.",
    images: {
      lg: 'dollop-lg.png',
      md: 'dollop-md.png',
      sm: 'dollop-sm.png',
  ...
  {
    name: 'Twinkle',
    description: "Three guesses what's put that twinkle in those eyes! (Hint: it's CNFT)",
    images: {
      lg: 'twinkle-lg.png',
      md: 'twinkle-md.png',
      sm: 'twinkle-sm.png',
  ...
  {
    name: 'Swapsies',
    description: 'These bunnies love nothing more than swapping cnftYields. Especially on BSC.',
    images: {
      lg: 'swapsies-lg.png',
      md: 'swapsies-md.png',
      sm: 'swapsies-sm.png',
  ...
  {
    name: 'Drizzle',
    description: "It's raining cnft on this bunny, but he doesn't seem to mind. Can you blame him?",
    images: {
      lg: 'drizzle-lg.png',
      md: 'drizzle-md.png',
      sm: 'drizzle-sm.png',
  ...
  {
    name: 'Blueberries',
    description: "These bunnies like their cnftYields with blueberries. What's your favorite topping?",
    images: {
  ...
  {
    name: 'Circular',
    description: "Love makes the world go 'round... but so do cnftYields. And these bunnies know it.",
    images: {
      lg: 'circular-lg.png',
      md: 'circular-md.png',
      sm: 'circular-sm.png',
  ...
  {
    name: 'Sparkle',
    description: 'It’s sparkling cnft, cnftYields, and even lottery tickets! This bunny really loves it.',
    images: {
      lg: 'sparkle-lg.png',
      md: 'sparkle-md.png',
      sm: 'sparkle-sm.png',
