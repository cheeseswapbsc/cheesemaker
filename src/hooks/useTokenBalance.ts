...
import { getBep20Contract, getCnftContract } from 'utils/contractHelpers'
...
export const useTotalSupply = () => {
  ...
  useEffect(() => {
    async function fetchTotalSupply() {
      const cnftContract = getCnftContract()
      const supply = await cnftContract.methods.totalSupply().call()
