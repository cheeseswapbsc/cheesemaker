...
import { Modal, Text, InjectedModalProps, Button, AutoRenewIcon } from '@cheeseswapfinance/uikit'
  ...
  return (
    <Modal title={TranslateString(999, 'Claim your Gift!')} onDismiss={onDismiss}>
      <div style={{ maxWidth: '640px' }}>
        <Text as="p">{TranslateString(999, 'Thank you for being a day-one user of CnftYield Profiles!')}</Text>
        <Text as="p" mb="8px">
          {TranslateString(
            999,
        ...
        <Text as="p">
          {TranslateString(999, "To make it up to you, we'll refund you the full 4 CNFT it cost to make your bunny.")}
        </Text>
        <Text as="p" mb="8px">
          {TranslateString(
            999,
        ...
        <Button
          ...
          disabled={!canClaim}
        >
          {TranslateString(999, 'Claim Your CNFT')}
        </Button>
      </div>
    </Modal>
  )
