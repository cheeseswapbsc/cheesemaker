...
import { Button, LinkExternal, useModal } from '@cheeseswapfinance/uikit'
...
const TicketCard: React.FC<{ contractLink?: string; lotteryNumber?: number }> = ({ contractLink, lotteryNumber }) => {
  ...
  return (
    <Wrapper>
      ...
      <div>
        <ExternalLinkWrap href={contractLink}>{TranslateString(356, 'View on BscInfo')}</ExternalLinkWrap>
      </div>
    </Wrapper>
  )
}
