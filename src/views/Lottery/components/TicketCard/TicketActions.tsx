...
import { Button, useModal } from '@cheeseswapfinance/uikit'
...
const TicketCard: React.FC = () => {
  ...
  const [onPresentBuy] = useModal(<BuyTicketModal max={cnftBalance} tokenName="CNFT" />)
      ...
      return (
        <>
          ...
          <Button width="100%" disabled={requestedApproval} onClick={handleApprove}>
            {TranslateString(494, 'Approve CNFT')}
          </Button>
        </>
      )
    }
