 ...
 * @see https://github.com/cnftYieldswap/gatsby-cnftYield-api/commit/e811b67a43ccc41edd4a0fa1ee704b2f510aa0ba
 */
export const baseUrl = 'https://api.cnftYieldswap.com/api/v1'
