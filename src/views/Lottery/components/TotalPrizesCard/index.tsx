...
import { Heading, Card, CardBody, CardFooter, Text, CnftfinanceRoundIcon, Flex, Skeleton } from '@cheeseswapfinance/uikit'
    ...
    <Card>
      <CardBody>
        ...
        <CardHeading>
          <Left>
            <IconWrapper>
              <CnftfinanceRoundIcon />
            </IconWrapper>
            <PrizeCountWrapper>
              <Text fontSize="14px" color="textSubtle">
                {TranslateString(722, 'Total Pot:')}
              </Text>
              <Heading size="lg">{lotteryPrizeWithCommaSeparators} CNFT</Heading>
            </PrizeCountWrapper>
          </Left>
          <Right>
