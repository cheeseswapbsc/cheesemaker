...
import { Heading, Text, BaseLayout } from '@cheeseswapfinance/uikit'
import useI18n from 'hooks/useI18n'
import Page from 'components/layout/Page'
import FarmStakingCard from 'views/Home/components/FarmStakingCard'
import CnftStats from 'views/Home/components/CnftStats'
...
const Hero = styled.div`
  align-items: center;
  background-image: url('/images/cnft-bg-mobile.svg');
  ...
  ${({ theme }) => theme.mediaQueries.lg} {
    background-image: url('/images/cnft-bg.svg'), url('/images/cnft-bg2.svg');
