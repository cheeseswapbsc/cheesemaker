...
import { Modal, LinkExternal, Box, Text } from '@cheeseswapfinance/uikit'
    ...
    <Modal title={`Contribute ${currency}`} onDismiss={onDismiss}>
      <Box maxWidth="400px">
        ...
        <Text as="p" mb="24px">
          {TranslateString(
            999,
            "If you don't contribute enough LP tokens, you may not receive any IDO tokens at all and will only receive a full refund of your LP tokens.",
          )}
        </Text>
