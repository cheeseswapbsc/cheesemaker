...
import { Heading, CardBody, CardFooter, CnftfinanceRoundIcon, TicketRound } from '@cheeseswapfinance/uikit'
      ...
      <>
        <CardBody>
          <CardHeading>
            ...
            <LotteryCardHeading
              valueToDisplay={TranslateString(999, `${poolSize.toLocaleString()} CNFT`)}
              Icon={CnftfinanceRoundIcon}
            >
